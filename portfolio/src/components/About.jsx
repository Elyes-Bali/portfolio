      ...
      <motion.div variants={fadeIn("right", "spring", 0.5*index, 0.75)} className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        <div options={{
          ...
          speed:450
            ...
            <h3 className="text-whte text-[20px] font-bold text-center">{title}</h3>
        </div>
      </motion.div>
    </Tilt>
  )
  ...
  return (
    <>
      ...
      <motion.p variants={fadeIn("", "", 0.1, 1)} className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        ...
        expertise in frameworks like React, Node.js, Flutter and Angular. I'm a
        quick learner and collaborate closely with clients to create efficient,
        scalable, and user-friendly solutions and solve real-world problems
      </motion.p>
